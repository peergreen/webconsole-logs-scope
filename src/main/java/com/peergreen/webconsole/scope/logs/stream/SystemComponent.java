 ...
 */
@Extension
@ExtensionPoint("com.peergreen.webconsole.scope.logs.LogsScope.tab")
@Tab("System output")
...
public class SystemComponent extends VerticalLayout implements SystemStream, LogListener {
    ...
    public SystemComponent() {
        ...
        addComponent(systemLayout);
        addComponent(loggerLayout);
